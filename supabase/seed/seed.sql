...
('c3333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', 'CareFirst Express Pharmacy', 'PH-LIC-2026-003', '12 Station Road', 'Mumbai', 'MH', '400001', '+1-800-555-0400', 'carefirst@demo.medilink.local', 'PENDING', NULL);
...
('m1111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'Paracetamol 500mg', 'Paracetamol / Acetaminophen', 'Fast effective relief from mild to moderate fever and muscle pain.', 'Analgesic', FALSE, 'AVAILABLE', 120),
('m2222222-2222-2222-2222-222222222222', 'a1111111-1111-1111-1111-111111111111', 'Amoxicillin 500mg Capsules', 'Amoxicillin Trihydrate', 'Broad spectrum antibiotic used to treat bacterial infections.', 'Antibiotics', TRUE, 'LIMITED', 15),
('m3333333-3333-3333-3333-333333333333', 'b2222222-2222-2222-2222-222222222222', 'Metformin 850mg Tablets', 'Metformin Hydrochloride', 'First-line medication for the treatment of type 2 diabetes.', 'Diabetes Care', TRUE, 'AVAILABLE', 85),
('m4444444-4444-4444-4444-444444444444', 'b2222222-2222-2222-2222-222222222222', 'Atorvastatin 20mg Tablets', 'Atorvastatin Calcium', 'Lowers cholesterol levels and helps reduce heart disease risk.', 'Cardiology', TRUE, 'UNAVAILABLE', 0),
('m5555555-5555-5555-5555-555555555555', 'a1111111-1111-1111-1111-111111111111', 'Cetirizine 10mg Allergy Relief', 'Cetirizine Hydrochloride', 'Non-drowsy antihistamine for seasonal allergy symptoms.', 'Allergy', FALSE, 'AVAILABLE', 200);
...
('r1111111-1111-1111-1111-111111111111', 'RES-2026-8801', '55555555-5555-5555-5555-555555555555', 'a1111111-1111-1111-1111-111111111111', 'm1111111-1111-1111-1111-111111111111', 'APPROVED', NOW() + INTERVAL '18 hours', NOW() - INTERVAL '2 hours'),
('r2222222-2222-2222-2222-222222222222', 'RES-2026-8802', '55555555-5555-5555-5555-555555555555', 'a1111111-1111-1111-1111-111111111111', 'm2222222-2222-2222-2222-222222222222', 'PENDING', NOW() + INTERVAL '22 hours', NOW() - INTERVAL '30 minutes'),
('r3333333-3333-3333-3333-333333333333', 'RES-2026-8803', '66666666-6666-6666-6666-666666666666', 'b2222222-2222-2222-2222-222222222222', 'm3333333-3333-3333-3333-333333333333', 'PENDING', NOW() + INTERVAL '12 hours', NOW() - INTERVAL '1 hour');
